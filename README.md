...
`cache.db`, подписки или файлы веб-интерфейса. Единственная общая зона —
маршрутизация трафика: если Mihomo перехватывает или отклоняет соединение
раньше `nfqws`, соответствующее правило нужно согласовать в самом Mihomo.
